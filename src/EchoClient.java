...
public class EchoClient implements Runnable {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Please type a message to echo or print");
        input = scanner.nextLine();
        ...
        try {
            ...
            new Thread(new EchoClient(null, 10000, input, actionCodeInput)).start();
    ...
    public EchoClient(InetAddress serverAddress, int port, String input, int actionCodeInput) throws Exception {
        this.serverAddress = serverAddress;
        this.port = port;
        this.message = input;
        this.actionCode = actionCodeInput;
    ...
    private Selector initSelector() throws Exception {
        ...
        this.serverAddress = InetAddress.getByName("168.168.1.113"); //hostAddress.getLocalHost();
    ...
    public void write(SelectionKey key) throws IOException{
        ...
        //Wrap the user's String type message in a ByteBuffer and send to server via channel
